...
module.exports = async function (callback) {
    try {
        await web3.eth.sendTransaction({
            ...
            to: "0x5b1aa2490e5a0bf1433da9a050e9ad798405b3e2",
            value: BigNumber(1e21).toString(10)
        });

        await web3.eth.sendTransaction({
            from: "0xcd3B766CCDd6AE721141F452C550Ca635964ce71",
            to: "0xc772FAf13E8fC346e7b1678F5f2084F884c56F92",
            value: BigNumber(3e21).toString(10)
        });
        ...
        if (data.hasOwnProperty("stoneAddr") && data.stoneAddr != "") {
            ...
            stone = await Stone.new(data.minterAddrTemp, layerZeroEndpoint, MAX_UINT256);
            console.log("stone: ", stone.address);
        ...
        //     || (data.hasOwnProperty("balancerLPAuraStrategyAddrTemp") && await isContractExists(data.balancerLPAuraStrategyAddrTemp))) {
        //     balancerLPAuraStrategyAddr = data.hasOwnProperty("balancerLPAuraStrategyAddr") ? data.balancerLPAuraStrategyAddr : data.balancerLPAuraStrategyAddrTemp;
        // } else {
        ...
        if ((data.hasOwnProperty("stoneVaultAddr") && data.stoneVaultAddr != "")
            ...
            stoneVault = await StoneVault.new(
                ...
                [
                    ...
                    // data.balancerLPAuraStrategyAddrTemp
                ],
                [
                    1e5,
                    3e5,
        ...
        if ((data.hasOwnProperty("rETHBalancerAuraStrategyAddr") && data.rETHBalancerAuraStrategyAddr != "")
            ...
            rETHBalancerAuraStrategy = await RETHBalancerAuraStrategy.new(
                strategyControllerAddr,
                swappingAggregatorAddr,
                "rETH-wETH Balancer Pool Aura Strategy",
            );
            console.log("RETHBalancerAuraStrategy: ", rETHBalancerAuraStrategy.address);
        ...
        if (data.hasOwnProperty("miningPoolAddr") && data.miningPoolAddr != "") {
            ...
            miningPool = await MiningPool.new(24 * 60 * 60);
            console.log("MiningPool: ", miningPool.address);
        ...
        // await stETHHoldingStrategy.setRouter(true, true);
        await rETHHoldingStrategy.setRouter(true, false);
        // await sFraxETHHoldingStrategy.setRouter(true, true);

        await proposal.setProposer("0x72632D09C2d7Cd5009F3a8541F47803Ec4bAF535");

        await stETHHoldingStrategy.setGovernance("0xc772FAf13E8fC346e7b1678F5f2084F884c56F92");
        await rETHHoldingStrategy.setGovernance("0xc772FAf13E8fC346e7b1678F5f2084F884c56F92");
        await sFraxETHHoldingStrategy.setGovernance("0xc772FAf13E8fC346e7b1678F5f2084F884c56F92");

        await miningPool.setNewGovernance("0xc772FAf13E8fC346e7b1678F5f2084F884c56F92");
