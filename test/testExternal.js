// truffle compile
// truffle exec scripts/testExternal.js --network local
...
module.exports = async function (callback) {
    try {
        ...
        let roll = await Roll.at("0xefE9269463aA75A9FE25C9E6a2674653f536503f");
        let gov1 = await rETHBalancerAuraStrategy.governance();
        let gov = await roll.governance();
        console.log("gov is : ", gov.toString(10));
        console.log("gov1 is : ", gov1.toString(10));
        await rETHBalancerAuraStrategy.setGovernance(roll.address, { from: gov1 })
        ...
        await roll.rollToNextRound(997000, gov, { from: gov });
        ...
        // user1Balance = await web3.eth.getBalance(user1);
        // console.log("user1Balance ether amount after instant withdraw:", user1Balance.toString());
        // assetsVaultBalance = await web3.eth.getBalance(assetsVaultAddress);
