...
contract("test_NullStrategy", async ([deployer, feeRecipient, taker1, taker2, taker3, proposer]) => {
    ...
    it("test16_taker1 deposit_rollToNext_withdraw all first_rollToNext_taker1 deposit", async () => {
        const stoneVault = await StoneVault.new(
            minter.address,
            proposalAddr,
            assetsVaultAddr,
    ...
    it("test19_onlyPermit can withdraw assetVault", async () => { });
    // should prohibit user from withdrawing before some specified time\\\\
