// node scripts/eigenlayer/6queryNode.js
...
nodeQuery = () => {
  const response = axios({
    ...
    method: "post",
    headers: headers,
    data: { "query": "{\n get_asset(keywords:[\"0x0DaD1AFEa01F04FdDC58d93c8Fce4Ee9540A30b0\"], page:1, page_size:10, protocols:[\"ethereum\"], sort_field:\"protocol\", reverse:false) {\n        asset {\n        id\n        name\n        protocol\n        wallet\n        validator\n        claimable_reward\n        active_stake\n        total_stake\n        received_reward\n        total_reward\n        last_action_time\n        pending_stake\n        unstaking\n        unstaking_in_progress\n        unstaking_withdrawable\n        }\n    count\n    }\n}" }
