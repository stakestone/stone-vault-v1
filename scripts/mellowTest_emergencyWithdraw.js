...
// emergency withdraw cannot be tested according to yuanhang, pls ignore.
module.exports = async function (callback) {
    try {
        ...
        await emergencyWithdrawFromMellow(mellowDepositWstETHStrategy, [BigNumber(10e18)], 1721151458);
        await checkStrategy(mellowDepositWstETHStrategy.address);
    ...
    async function emergencyWithdrawFromMellow(strategy, amount, timestamp) {
        console.log(`======== emergencyWithdrawFromMellow ${amount} ETH ========`)
        await strategy.emergencyWithdrawFromMellow(amount, timestamp);
    }
