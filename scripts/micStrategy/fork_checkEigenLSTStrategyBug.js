...
module.exports = async function (callback) {
    try {
        ...
        console.log("--- Step 10: Execute rollToNextRound ---");
        console.log("\n⏳ 等待提款期 (100800 区块)...");
        await mineBlocks(100800);
        ...
        console.log("Rebalance successful. TX:", rollTx.tx);
        valuesAfterRebalance = await printAllValues("After Rebalance before go to Lido ");
        // console.log("--- Step 8: start completeQueuedWithdrawal --------");
        // 处理剩余的 stETH
        console.log("\n--- Step 10: 处理剩余 stETH ---");
